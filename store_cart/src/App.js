...
<p className="mt-1 text-sm text-gray-500">Rating:
...
<h1 className="text-3xl mb-2 font-bold text-white"> Group 33's Shop
</h1>
<p className="text-gray-700 text-white">
by - <b style={{ color: 'orange' }}>Chanho Yang, Taewan Kim</b>
</p>
<div className="py-10">
